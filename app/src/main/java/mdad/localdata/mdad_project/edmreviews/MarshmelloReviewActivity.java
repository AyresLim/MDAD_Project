...
public class MarshmelloReviewActivity extends AppCompatActivity {

    private static final String url_create_product = FirstMarshmelloFragment.ipBaseAddress+"/create_reviewJson.php";
    String pid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_marshmello_review);
