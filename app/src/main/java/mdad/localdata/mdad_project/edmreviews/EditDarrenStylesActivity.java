...
import mdad.localdata.mdad_project.edmfragments.FirstDarrenStylesFragment;

public class EditDarrenStylesActivity extends AppCompatActivity {

    // url to get selected product details
    private static final String url_review_details =
            FirstDarrenStylesFragment.ipBaseAddress+"/get_review_detailsJson.php";
    // url to update product
    private static final String url_update_review =
            FirstDarrenStylesFragment.ipBaseAddress+"/update_reviewJson.php";
    // url to delete product
    private static final String url_delete_review =
            FirstDarrenStylesFragment.ipBaseAddress+"/delete_reviewJson.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_darren_styles);
    ...
    public void checkResponseSave_delete_Product(JSONObject response) {
        try {
            ...
            if (response.getInt("success") == 1) {
                ...
                Intent i = new Intent(this, FirstDarrenStylesFragment.class);
                startActivity(i);
            } else {
