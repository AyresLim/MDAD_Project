...
import mdad.localdata.mdad_project.edmfragments.FirstMartinGarrixFragment;

public class EditMartinGarrixActivity extends AppCompatActivity {
    ...
    private static final String url_review_details =
            FirstMartinGarrixFragment.ipBaseAddress+"/get_review_detailsJson.php";
    // url to update product
    private static final String url_update_review =
            FirstMartinGarrixFragment.ipBaseAddress+"/update_reviewJson.php";
    // url to delete product
    private static final String url_delete_review =
            FirstMartinGarrixFragment.ipBaseAddress+"/delete_reviewJson.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_martin_garrix);
    ...
    public void checkResponseSave_delete_Product(JSONObject response) {
        try {
            ...
            if (response.getInt("success") == 1) {
                ...
                Intent i = new Intent(this, FirstMartinGarrixFragment.class);
                startActivity(i);
            } else {
