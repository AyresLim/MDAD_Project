...
public class MartinGarrixReviewActivity extends AppCompatActivity {

    private static final String url_create_product = FirstMartinGarrixFragment.ipBaseAddress+"/create_reviewJson.php";
    String pid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_martin_garrix_review);
