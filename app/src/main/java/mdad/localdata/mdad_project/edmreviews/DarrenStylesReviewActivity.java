...
public class DarrenStylesReviewActivity extends AppCompatActivity {

    private static final String url_create_product = FirstDarrenStylesFragment.ipBaseAddress+"/create_reviewJson.php";
    String pid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_darren_styles_review);
...
//check if the response if successful
            if (response.getInt("success") == 1) {
                Toast.makeText(getApplicationContext(), "Create Review Success",
