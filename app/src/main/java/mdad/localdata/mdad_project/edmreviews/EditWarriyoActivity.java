...
public class EditWarriyoActivity extends AppCompatActivity {

    // url to get selected product details
    private static final String url_review_details =
            FirstWarriyoFragment.ipBaseAddress+"/get_review_detailsJson.php";
    // url to update product
    private static final String url_update_review =
            FirstWarriyoFragment.ipBaseAddress+"/update_reviewJson.php";
    // url to delete product
    private static final String url_delete_review =
            FirstWarriyoFragment.ipBaseAddress+"/delete_reviewJson.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_warriyo);
